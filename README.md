...
- [Demo Apps / 示例程序](#demo-apps)
  - [iOS](#ios)
    - [Apple Watch](#watch)
    - [tvOS](#tvos)
  - [OS X](#os-x)
- [Dependency Managers / 包管理软件](#dependency-managers)
- [Guides / 教程](#guides)
- [Patterns / 设计模式](#patterns)
- [Editor Support / 编辑器支持](#editor-support)
  - [Emacs](#emacs)
  - [Vim](#vim)
- [Libs / 库](#libs)
  - [Animation / 动画](#animation)
  - [App Routing / 应用跳转](#app-routing)
  ...
  - [Data Management / 数据库管理](#data-management)
    - [Core Data](#core-data)
    ...
    - [Other / 其它](#other)
  - [Date / 日期和时间](#date)
  - [Embedded Systems / 嵌入式系统](#embedded-systems)
    - [Peripherals / 外设](#peripherals)
  - [Events / 事件处理](#events)
  - [Fonts / 字体](#fonts)
  - [Gesture / 手势](#gesture)
  - [iBeacon / 室内定位](#ibeacon)
  - [Images / 图像](#images)
  ...
  - [Network / 网路](#network)
    - [Html](#html)  
    - [Webserver / 服务器](#webserver)
    - [Websocket / 套接字](#websocket)
  ...
  - [Testing / 测试](#testing)
  - [Text / 文本](#text)
    - [Phone Numbers / 电话号码](#phone-numbers)
  - [Thread / 线程](#thread)
  - [UI / 用户界面](#ui)
    - [Alert / 弹出警告](#alert) 	
    - [Blur / 背景模糊](#blur)
